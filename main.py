...
# 1. استقبال الفيديو (يستخرج المدة تلقائياً)
...
# 3. استقبال الرقم والنشر (بالتنسيق المطلوب)
...
async def receive_ep_number(client, message):
    ...
    # --- أزرار تفاعلية (مشاهدة الآن + زر تفاعلي وهمي للجمالية) ---
    ...
    await message.reply_text(f"✅ تم النشر بالتنسيق الجديد في القناة!")
...
# استجابة الأزرار التفاعلية (لجعلها تعطي شعوراً بالحيوية)
